...
#         continue
#     imports = [imp.path for imp in parsed_tree.imports]
#     test_classes = []
#     for _, class_node in parsed_tree.filter(ClassDeclaration):
#         test_classes.append(TestClass(parsed_class=class_node, imports=imports))
#     for test_class in test_classes:
#         for method in test_class.test_methods:
#             for assertion in method.assertions:
#                 total_assertions += 1
#                 if assertion.std_lib_dependencies:
#                     print(assertion.std_lib_dependencies)
#                     assertions_with_std += 1

# ratio = assertions_with_std / total_assertions if total_assertions > 0 else 0
# print("Total assertions:", total_assertions)
# print("Assertions with std lib dependencies:", assertions_with_std)
